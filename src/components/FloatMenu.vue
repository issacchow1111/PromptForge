      ...
      <div v-if="isOpen" class="menu-dropdown">
        ...
        <div class="menu-section">
          ...
          >
            ...
            <span class="menu-section-title">自定义模型选择</span>
            <span
              v-if="hasUserKey"
            ...
            >未配置</span>
            <svg class="chevron" :class="{ expanded: configExpanded }" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
              <polyline points="6 9 12 15 18 9"/>
            </svg>
          </div>

          <Transition name="expand">
            <div v-if="configExpanded" class="menu-form">
              <div class="form-row">
                <label>模型厂商</label>
